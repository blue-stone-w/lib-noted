...
namespace cv
{
    ...
    */
    ...
    function file: /modules/imgproc/src/rotcalipers.cpp
     */
    ...
    */
    ...
    function file: modeles/imgproc/src/convhull.cpp
     */
    ...
    public:
        ...
        */
        ...
        LineIterator(Point pt1, Point pt2,
                     int connectivity = 8, bool leftToRight = false)
        {
            init(0, Rect(std::min(pt1.x, pt2.x), std::min(pt1.y, pt2.y), std::max(pt1.x, pt2.x) - std::min(pt1.x, pt2.x) + 1, std::max(pt1.y, pt2.y) - std::min(pt1.y, pt2.y) + 1),
